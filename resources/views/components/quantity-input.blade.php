<form class="max-w-xs mx-auto">
    ...
    <div class="relative flex items-center max-w-[8rem]">
        ...
        <button type="button" id="decrement-button" data-input-counter-decrement="quantity-input" 
            class="bg-white hover:bg-gray-100 border border-gray-300 rounded-s-lg p-3 h-11 focus:ring-gray-200 focus:ring-2 focus:outline-none">
        ...
        <button type="button" id="increment-button" data-input-counter-increment="quantity-input" 
            class="bg-white hover:bg-gray-100 border border-gray-300 rounded-e-lg p-3 h-11 focus:ring-gray-200 focus:ring-2 focus:outline-none">
