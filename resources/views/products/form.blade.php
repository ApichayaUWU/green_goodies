            ...
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6 text-gray-900">
                    ...
                    >
                        ...
                        <svg id="toggleIcon" xmlns="http://www.w3.org/2000/svg" class="ml-2 h-5 w-5 transition-transform transform rotate-0" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M5 15l7-7 7 7" />
                        </svg>
                    </button>

                    {{-- Form for creating and editing a product --}}
                    <div id="productForm" class="mt-4 hidden overflow-hidden transition-all duration-500 ease-in-out max-h-0">
                        ...
                        >
                            ...
                            <div class="mb-4">
                                ...
                                />
                                <div class="mt-2">
                                    <img id="imagePreview" src="{{ isset($product) ? asset('storage/' . $product->image) : '#' }}" alt="Image Preview" class="{{ isset($product) ? '' : 'hidden' }}" width="150">
                                </div>
                            </div>
