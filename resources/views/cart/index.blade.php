<x-app-layout>
    ...
    <div class="bg-[#53B637] text-center w-[200px] rounded-[40px] mt-10 mb-4 mx-8 flex flex-row justify-center">
        <div>
            <svg xmlns="http://www.w3.org/2000/svg" width="30" height="30" fill="white" class="bi bi-cart mt-4 mr-2" viewBox="0 0 16 16">
            ...
            <div class="bg-white overflow-hidden shadow-sm">
                ...
                <div class="p-6 text-gray-900">
                    ...
                    <div class = "flex flex-row justify-center">
                        <div><svg xmlns="http://www.w3.org/2000/svg" width="250" height="250" fill="#b8b8b8" class="bi bi-cart-x" viewBox="0 0 16 16">
